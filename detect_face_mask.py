...
not_weared_mask = "Silahkan menggunakan masker!!!"
...
while 1:
    ...
    (thresh, black_and_white) = cv2.threshold(gray_img, bw_threshold, 255, cv2.THRESH_BINARY)
    ...
    if(len(faces) == 0 and len(faces_bw) == 0):
        ...
        for (x, y, w, h) in faces:
            ...
            mouth_rects = mouth_cascade.detectMultiScale(gray_img, 1.5, 5)
